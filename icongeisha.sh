...
# アイコン生成パラメータ "[目的] [サイズ] [倍率]" の順に並ぶ
#   用途 : アイコンの用途。iphone, ipad, ios-marketing のいずれかを使用 (2018.03現在)。
#   サイズ : 倍率適用前の一辺の長さ。
#   倍率 : 高解像度ディスプレイのための倍率 1, 2, 3 のいずれかを使用 (2018.03現在)。
# ファイル名と実際の画像サイズはこれらのパラメータから決められる。
testcases=(
    "iphone 20 2"
    "iphone 20 3"
    "iphone 29 2"
